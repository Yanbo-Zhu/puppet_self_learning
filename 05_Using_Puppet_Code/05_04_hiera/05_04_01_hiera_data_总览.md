...
# 3 Hiera configuration layers

## 3.1 layered hierarchies 的顺序 
...
#### 3.2.1.1 `hiera_config` setting in `puppet.conf



### 3.2.2 The environment layer
...
## 3.3 Tips for making a good hierarchy
...
## 5.1 Hierarchies interpolate variables
...
## 5.2 用 lookup 來取得其他的 hiera data
...
## 5.3 用 alias 直接對應相同的 hiera data
...
## 5.4 literal 用來處理有 ‘%’ 的 hiera data
